...
export default function CheckoutInfo() {
    ...
    // const [member, setMember]= useState({}); // orderList와 저장된 영역이 달라 사용 불가능
    ...
    return (
        ...
        <div className="section">
            ...
            <div className="info-grid">
                ...
                <div className="value">{member.adress ? member.adress / member.address : "배송 정보를 입력해주세요."}</div>
            ...
            <div className="info-grid">
                {
                    orderList && orderList.map((item) => 
                        <>
                            ...
                            <div className="value">{item.pname} / {item.size} / {item.qty}개</div>
                        </>
                    )
                }
